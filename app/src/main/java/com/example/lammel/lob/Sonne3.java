...
/**
 * Sonne3 ist eine der Sonne der Erkenntnis - Fragen
...
public class Sonne3 extends FragmentActivity implements View.OnClickListener, AppCompatCallback {
    ...
    private static final String TAG = "Sonne3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playEnabled = (ImageView) findViewById(R.id.play3_Button);
        playEnabled.setOnClickListener(this);


        play = (ImageView) findViewById(R.id.playhell3_Button);


        pause = (ImageView) findViewById(R.id.pause3_Button);
        pause.setOnClickListener(this);

        record = (ImageView) findViewById(R.id.microphone3_Button1);
        record.setVisibility(View.VISIBLE);
        record.setOnClickListener(this);

        recordOn = (ImageView) findViewById(R.id.microphone3_Button2);
        recordOn.setOnClickListener(this);

        //Progress
        progressBar = (ProgressBar) findViewById(R.id.progressBar3);
        startValue = (TextView) findViewById(R.id.start3_TextView);
        endValue = (TextView) findViewById(R.id.end3_TextView);
        run = true;
        handler = new Handler();

        //RecordTimer
        timeView = (TextView) findViewById(R.id.timer3_TextView);
        rHandler = new Handler();
        startTimer = false;
        fertig = (Button) findViewById(R.id.fertig3_Button);

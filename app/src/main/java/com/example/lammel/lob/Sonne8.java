...
/**
 * Sonne8 ist eine der Sonne der Erkenntnis - Fragen
...
public class Sonne8 extends FragmentActivity implements View.OnClickListener, AppCompatCallback {
    ...
    private static final String MEDIA_NAME = "sonne8";

    //Tracker
    private Tracker mTracker;
    private static final String TAG = "Sonne8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.add(R.id.sonne8_xml, fragment);
        transaction.commit();
        ...
        delegate.setContentView(R.layout.activity_sonne8);
        ...
        playEnabled = (ImageView) findViewById(R.id.play8_Button);
        playEnabled.setOnClickListener(this);


        play = (ImageView) findViewById(R.id.playhell8_Button);


        pause = (ImageView) findViewById(R.id.pause8_Button);
        pause.setOnClickListener(this);

        record = (ImageView) findViewById(R.id.microphone8_Button1);
        record.setVisibility(View.VISIBLE);
        record.setOnClickListener(this);

        recordOn = (ImageView) findViewById(R.id.microphone8_Button2);
        recordOn.setOnClickListener(this);

        //Progress
        progressBar = (ProgressBar) findViewById(R.id.progressBar8);
        startValue = (TextView) findViewById(R.id.start8_TextView);
        endValue = (TextView) findViewById(R.id.end8_TextView);
        run = true;
        handler = new Handler();

        //RecordTimer
        timeView = (TextView) findViewById(R.id.timer8_TextView);
        rHandler = new Handler();
        startTimer = false;
        fertig = (Button) findViewById(R.id.fertig8_Button);

...
public class Level1Start extends FragmentActivity implements View.OnClickListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level1_start);
        ...
        transaction.add(R.id.level1_start, fragment);
        transaction.commit();
        ...
        delegate.setContentView(R.layout.activity_level1_start);
        ...
        level1Weiter = (Button) findViewById(R.id.level1Start_Button);
        level1Weiter.setOnClickListener(this);
    }

...
/**
 * Sonne2 ist eine der Sonne der Erkenntnis - Fragen
...
public class Sonne2 extends FragmentActivity implements View.OnClickListener, AppCompatCallback {
    ...
    private static final String MEDIA_NAME = "sonne2";

    //Tracker
    private Tracker mTracker;
private static final String TAG = "Sonne2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.add(R.id.sonne2_xml, fragment);
        transaction.commit();
        ...
        delegate.setContentView(R.layout.activity_sonne2);
        ...
        playEnabled = (ImageView) findViewById(R.id.play2_Button);
        playEnabled.setOnClickListener(this);


        play = (ImageView) findViewById(R.id.playhell2_Button);


        pause = (ImageView) findViewById(R.id.pause2_Button);
        pause.setOnClickListener(this);

        record = (ImageView) findViewById(R.id.microphone2_Button1);
        record.setVisibility(View.VISIBLE);
        record.setOnClickListener(this);

        recordOn = (ImageView) findViewById(R.id.microphone2_Button2);
        recordOn.setOnClickListener(this);

        //Progress
        progressBar = (ProgressBar) findViewById(R.id.progressBar3);
        startValue = (TextView) findViewById(R.id.start3_TextView);
        endValue = (TextView) findViewById(R.id.end2_TextView);
        run = true;
        handler = new Handler();

        //RecordTimer
        timeView = (TextView) findViewById(R.id.timer2_TextView);
        rHandler = new Handler();
        startTimer = false;
        fertig = (Button) findViewById(R.id.fertig2_Button);

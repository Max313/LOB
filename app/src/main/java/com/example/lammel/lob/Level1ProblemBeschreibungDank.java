...
public class Level1ProblemBeschreibungDank extends FragmentActivity implements View.OnClickListener, AppCompatCallback {
    ...
    //Hier bedankt sich die App für die Beschreibung des Problems
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.add(R.id.problem_BeschreibungDank, fragment);
        transaction.commit();
        ...
        delegate.setContentView(R.layout.activity_level1_problem_beschreibung_dank);

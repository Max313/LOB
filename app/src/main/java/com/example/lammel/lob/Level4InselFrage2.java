...
/**
 * Level4InselFrage2 ist die zweite Frage der Übung Insel des Sehenden
 * Der Nutzer kann die Antwort aufschreiben wenn er will
 * Text und Textingabemöglichkeit
 */

public class Level4InselFrage2 extends FragmentActivity implements View.OnClickListener, AppCompatCallback {


    //Buttons and more
    private Button weiter;
    private EditText frage2;
    private String eingabe = "Eingabemöglichkeit";
    private String eingabe2;
    private AppCompatDelegate delegate;

    private final static String TAG = "InselFrage2";
    private long start;
    private long end;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.add(R.id.level4_insel_frage2, fragment);
        transaction.commit();
        ...
        delegate.setContentView(R.layout.activity_level4_insel_frage2);
        ...
        eingabe2 = saved.getString("Frage2Save", eingabe);
        frage2 = (EditText) findViewById(R.id.frage2_editView);
        frage2.setHorizontallyScrolling(false);
        frage2.setLines(3);
        frage2.setHint(eingabe2);

        frage2.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
    ...
    public void onClick(View view) {
        ...
        saved = getSharedPreferences(PREFS_NAME,0);
        editor = saved.edit();
        if(frage2.getText().toString().length() != 0){
            editor.putString("Frage2Save", frage2.getText().toString());
            editor.apply();
        }
        //logging

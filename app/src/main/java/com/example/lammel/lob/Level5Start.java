...
public class Level5Start extends FragmentActivity implements View.OnClickListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.add(R.id.level5_start, fragment);
        transaction.commit();
        ...
        delegate.setContentView(R.layout.activity_level5_start);
        ...
        level5Weiter = (Button) findViewById(R.id.level5Start_Button);
        level5Weiter.setOnClickListener(this);
    }

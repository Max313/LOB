...
public class Sonne1 extends FragmentActivity implements View.OnClickListener, AppCompatCallback {
    ...
    private final static String TAG = "Sonne1";
    private final static String name = "Sonne1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playEnabled = (ImageView) findViewById(R.id.play1_Button);
        playEnabled.setOnClickListener(this);


        play = (ImageView) findViewById(R.id.playhell1_Button);
        ...
        endValue = (TextView) findViewById(R.id.end1_TextView);
        run = true;
        handler = new Handler();

        //RecordTimer
        timeView = (TextView) findViewById(R.id.timer1_TextView);
        rHandler = new Handler();
        startTimer = false;
        fertig = (Button) findViewById(R.id.fertig1_Button);

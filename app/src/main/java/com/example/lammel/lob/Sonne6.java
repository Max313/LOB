...
public class Sonne6 extends FragmentActivity implements View.OnClickListener, AppCompatCallback {
    ...
    private static final String MEDIA_NAME = "sonne6";

    //Tracker
    private Tracker mTracker;
    private final static String TAG = "Sonne6";
    private final static String name = "Sonne6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playEnabled = (ImageView) findViewById(R.id.play6_Button);
        playEnabled.setOnClickListener(this);


        play = (ImageView) findViewById(R.id.playhell6_Button);


        pause = (ImageView) findViewById(R.id.pause6_Button);
        pause.setOnClickListener(this);

        record = (ImageView) findViewById(R.id.microphone6_Button1);
        record.setVisibility(View.VISIBLE);
        record.setOnClickListener(this);

        recordOn = (ImageView) findViewById(R.id.microphone6_Button2);
        recordOn.setOnClickListener(this);

        //Progress
        progressBar = (ProgressBar) findViewById(R.id.progressBar6);
        startValue = (TextView) findViewById(R.id.start6_TextView);
        endValue = (TextView) findViewById(R.id.end6_TextView);
        run = true;
        handler = new Handler();

        //RecordTimer
        timeView = (TextView) findViewById(R.id.timer6_TextView);
        rHandler = new Handler();
        startTimer = false;
        fertig = (Button) findViewById(R.id.fertig6_Button);

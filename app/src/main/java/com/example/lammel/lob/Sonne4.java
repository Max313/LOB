...
public class Sonne4 extends FragmentActivity implements View.OnClickListener, AppCompatCallback {
    ...
    private static final String MEDIA_NAME = "sonne4";
    ...
    private final static String TAG = "Sonne4";
    private final static String name = "Sonne4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Sonne der Erkenntnis 4/8");

        //Add Footer
        Footer_Fragment fragment = new Footer_Fragment();
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        transaction.add(R.id.sonne4_xml, fragment);
        transaction.commit();
        ...
        delegate.setContentView(R.layout.activity_sonne4);
        ...
        playEnabled = (ImageView) findViewById(R.id.play4_Button);
        playEnabled.setOnClickListener(this);


        play = (ImageView) findViewById(R.id.playhell4_Button);


        pause = (ImageView) findViewById(R.id.pause4_Button);
        pause.setOnClickListener(this);

        record = (ImageView) findViewById(R.id.microphone4_Button1);
        record.setVisibility(View.VISIBLE);
        record.setOnClickListener(this);

        recordOn = (ImageView) findViewById(R.id.microphone4_Button2);
        recordOn.setOnClickListener(this);

        //Progress
        progressBar = (ProgressBar) findViewById(R.id.progressBar4);
        startValue = (TextView) findViewById(R.id.start4_TextView);
        endValue = (TextView) findViewById(R.id.end4_TextView);
        run = true;
        handler = new Handler();

        //RecordTimer
        timeView = (TextView) findViewById(R.id.timer4_TextView);
        rHandler = new Handler();
        startTimer = false;
        fertig = (Button) findViewById(R.id.fertig4_Button);
